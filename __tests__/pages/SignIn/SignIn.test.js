...
describe('SignIn page', () => {
  ...
  it('should be able to sign in on app', () => {
    ...
    expect(getByTestId('signin-btn')).toContainElement(getByText('Loading...'));
  });

  it('should store heroes in storage', () => {
    let { getByTestId, getByLabelText } = render(<SignIn />);
    ...
    ({ getByTestId, getByLabelText, getByText } = render(<SignIn />));
          ...
          urls: [
            {
              type: 'detail',
              url:
                'http://marvel.com/comics/characters/1011334/3-d_man?utm_campaign=apiRef&utm_source=83908b478d58b1de4d680a466b48bdc4',
            },
            {
              type: 'wiki',
              url:
                'http://marvel.com/universe/3-D_Man_(Chandler)?utm_campaign=apiRef&utm_source=83908b478d58b1de4d680a466b48bdc4',
            },
            {
              type: 'comiclink',
              url:
