...
describe('SignIn saga', () => {
  it('should be able to fetch heroes', async () => {
    ...
    apiMock
      .onGet(
        '/v1/public/characters' +
          `?ts=${1585590378}` +
          `&apikey=${'83908b478d58b1de4d680a466b48bdc4'}` +
          `&hash=${'50b4dc0fb6a589b07e96cab26553a906'}` +
          `&limit=1`
      )
      .reply(200, {
        code: 200,
    ...
    await runSaga({ dispatch }, signIn).toPromise();

    expect(dispatch).toHaveBeenCalledWith(
      signInSuccess({
        token: '7bb636649b1f4d55f86acadce35ba38d8e0aa683',
        timestamp: 1585590378,
        publickey: '83908b478d58b1de4d680a466b48bdc4',
        hash: '50b4dc0fb6a589b07e96cab26553a906',
        heroes: [
          {
            id: 1011334,
